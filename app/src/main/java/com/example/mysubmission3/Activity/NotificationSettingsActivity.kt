...
import com.example.mysubmission3.alarm.AlarmReceiver
import com.example.mysubmission3.databinding.ActivityNotificationSettingsBinding
...
class NotificationSettingsActivity : AppCompatActivity() {
    ...
    private fun setSwitch() {
        swOnOff.isChecked = mSharedPreferences.getBoolean(DAILY, false)
    }
