package com.example.mysubmission3.alarm
...
import com.example.mysubmission3.Activity.MainActivity
    ...
    override fun onReceive(context: Context, intent: Intent) {
     ...
     fun setDailyReminder(context: Context, type: String, message: String){
        ...
        val pendingIntent = PendingIntent.getBroadcast(context, ID_DAILY, intent, PendingIntent.FLAG_ONE_SHOT)
         ...
         Toast.makeText(context, "Daily Reminder is turnedON", Toast.LENGTH_SHORT).show()
    }
     ...
     fun cancelAlarm(context: Context){
        ...
        Toast.makeText(context, "Daily Reminder is turnedOFF", Toast.LENGTH_SHORT).show()
    }
